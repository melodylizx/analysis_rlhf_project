...
#SBATCH -o /home/mila/z/zixuan.li/output/unbiased/our_perfect-%j.out  # Write the log on scratch
...
deepspeed examples/summarize_rlhf/reward_model/train_reward_model_new.py --path="/network/scratch/z/zixuan.li/generated_dataset/perfect" --output="/network/scratch/z/zixuan.li/experiment_reward_model/perfect"

#BEST_CHECKPOINT_PATH=$(jq -r '.best_model_checkpoint' /network/scratch/z/zixuan.li/experiment_reward_model/perfect/seed_4/best/checkpoint-1000/trainer_state.json)
