...
#echo BESTCHPT
BESTCHPT=/network/scratch/i/ines.arous/experiment_reward_model/random_sampling/01/2024_12_24_18_29/checkpoint-60/pytorch_model.bin
foldername=$(date +%Y_%m_%d_%H_%M)
SAVEPATH=/network/scratch/i/ines.arous/ppo/random_sampling/01/2025_01_08_07_19
mkdir -p ${SAVEPATH}
accelerate launch --config_file configs/default_accelerate_config.yaml new_ppo.py --run_id='6mrl4ylp' --ckpt_path="${BESTCHPT}" --save_path="${SAVEPATH}" --perc=0.01
