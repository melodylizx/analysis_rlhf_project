...
CHPTPATH=/network/scratch/i/ines.arous/experiment_reward_model/20/20_2024_01_09_14_11



deepspeed ./reward_model/train_reward_model_gptj.py --local_rank=0  --data_path="/network/scratch/i/ines.arous/data_rlhf/percent/0.2/"  --chpt_path="${CHPTPATH}"
