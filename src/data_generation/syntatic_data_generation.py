...
unique_eval = overlap_axis_val[['summary_id','overall', 'accuracy', 'coverage', 'coherence']].groupby('summary_id').mean()
...
# generated_df = worker_modeling.introduce_bias(generated_df, bias_accuracy, bias_coverage, bias_coherence, bias_towards_0, bias_towards_1)
