...
if __name__ == "__main__":
    output_dir = "/network/scratch/z/zixuan.li/gptj-supervised-summarize-checkpoint"
    #train_batch_size = 16
    train_batch_size = 16
    ...
    training_args = TrainingArguments(
        ...
        #logging_steps=50,
        logging_steps=50,
        deepspeed="/home/mila/z/zixuan.li/trlx/examples/summarize_rlhf/sft/ds_config_gptj.json",
    )
